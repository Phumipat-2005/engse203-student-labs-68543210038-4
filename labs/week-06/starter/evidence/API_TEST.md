...
**ชื่อ–รหัส:** นายภูมิพัฒน์ วงศ์ดาว **วันที่ทดสอบ:** 16/09/2026
...
|---|---|---|
| 1 | POST เพิ่มคำร้องใหม่ | ได้ status 201 พร้อม object ข้อมูลและรหัส ID ใหม่ |
| 2 | GET ดูรายการ — เห็นคำร้องใหม่ไหม | เห็นคำร้องที่พึ่งเพิ่มมาใหม่เเสดงในรายการ |
| 3 | Ctrl+C ปิดเซิร์ฟเวอร์ แล้วเปิดใหม่ | เซิร์ฟเวอร์หยุดและเปิดใหม่ได้ตามปกติ |
| 4 | GET ดูรายการอีกครั้ง — คำร้องยังอยู่ไหม | ยังอยู่ครบถ้วน ข้อมูลไม่สูญหาย |
